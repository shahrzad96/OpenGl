...
echo zipname = "packed">> __tmpJustZipCI4500.vbs
...
if exist packed.zip goto success
...
:success
echo.
echo Your files have been successfully packed into the following file: packed.zip
