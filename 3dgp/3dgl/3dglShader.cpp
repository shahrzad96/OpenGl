...
{
	GLuint location; GLenum _t, t; GetUniformLocation(name, location, _t, t);
	if (t == GL_FLOAT) SendUniform(location, v0);
...
{
	GLuint location; GLenum _t, t; GetUniformLocation(name, location, _t, t);
	if (t == GL_FLOAT_VEC2) SendUniform(location, v0, v1);
...
{
	GLuint location; GLenum _t, t; GetUniformLocation(name, location, _t, t);
	if (t == GL_FLOAT_VEC3) SendUniform(location, v0, v1, v2);
...
{
	GLuint location; GLenum _t, t; GetUniformLocation(name, location, _t, t);
	if (t == GL_FLOAT_VEC4) SendUniform(location, v0, v1, v2, v3);
...
{
	GLuint location; GLenum _t, t; GetUniformLocation(name, location, _t, t);
	if (t == GL_FLOAT_MAT4) SendUniform(location, pMatrix);
...
{
	GLuint location; GLenum _t, t; GetUniformLocation(name, location, _t, t);
	if (t == GL_INT) SendUniform1v(location, p, count);
	else return _error(name, GL_INT, t);
	return true;
}
...
{
	GLuint location; GLenum _t, t; GetUniformLocation(name, location, _t, t);
	if (t == GL_INT_VEC2) SendUniform2v(location, p, count);
	else return _error(name, GL_INT_VEC2, t);
	return true;
}
...
{
	GLuint location; GLenum _t, t; GetUniformLocation(name, location, _t, t);
	if (t == GL_INT_VEC3) SendUniform3v(location, p, count);
	else return _error(name, GL_INT_VEC3, t);
	return true;
}
...
{
	GLuint location; GLenum _t, t; GetUniformLocation(name, location, _t, t);
	if (t == GL_INT_VEC4) SendUniform4v(location, p, count);
	else return _error(name, GL_INT_VEC4, t);
	return true;
}
...
{
	GLuint location; GLenum _t, t; GetUniformLocation(name, location, _t, t);
	if (t == GL_UNSIGNED_INT) SendUniform1v(location, p, count);
	else return _error(name, GL_UNSIGNED_INT, t);
	return true;
}
...
{
	GLuint location; GLenum _t, t; GetUniformLocation(name, location, _t, t);
	if (t == GL_UNSIGNED_INT_VEC2) SendUniform2v(location, p, count);
	else return _error(name, GL_UNSIGNED_INT_VEC2, t);
	return true;
}
...
{
	GLuint location; GLenum _t, t; GetUniformLocation(name, location, _t, t);
	if (t == GL_UNSIGNED_INT_VEC3) SendUniform3v(location, p, count);
	else return _error(name, GL_UNSIGNED_INT_VEC3, t);
	return true;
}
...
{
	GLuint location; GLenum _t, t; GetUniformLocation(name, location, _t, t);
	if (t == GL_UNSIGNED_INT_VEC4) SendUniform4v(location, p, count);
	else return _error(name, GL_UNSIGNED_INT_VEC4, t);
	return true;
}
...
{
	GLuint location; GLenum _t, t; GetUniformLocation(name, location, _t, t);
	if (t == GL_FLOAT) SendUniform1v(location, p, count);
	else return _error(name, GL_FLOAT, t);
	return true;
}
...
{
	GLuint location; GLenum _t, t; GetUniformLocation(name, location, _t, t);
	if (t == GL_FLOAT_VEC2) SendUniform2v(location, p, count);
	else return _error(name, GL_FLOAT_VEC2, t);
	return true;
}
...
{
	GLuint location; GLenum _t, t; GetUniformLocation(name, location, _t, t);
	if (t == GL_FLOAT_VEC3) SendUniform3v(location, p, count);
	else return _error(name, GL_FLOAT_VEC3, t);
	return true;
}
...
{
	GLuint location; GLenum _t, t; GetUniformLocation(name, location, _t, t);
	if (t == GL_FLOAT_VEC4) SendUniform4v(location, p, count);
	else return _error(name, GL_FLOAT_VEC4, t);
	return true;
}
...
{
	GLuint location; GLenum _t, t; GetUniformLocation(name, location, _t, t);
	if (t == GL_FLOAT_MAT4) SendUniformMatrixv(location, pMatrix, count);
	else return _error(name, GL_FLOAT_MAT4, t);
	return true;
}
